...
// JS for EmailJS - Normal Loading
<!-- JS from Head -->
<script type="text/javascript" src="assets/js/4_dist_email.js?v=2.0.1" defer></script>

// EmailJS Loading - Normal Version
<script type="text/javascript" src="assets/js/4_dist_email.js?v=2.0.1" defer></script>
...
<script type="text/javascript">
   (function(){
   emailjs.init({
      publicKey: "7ILWL54OoZjnIZneX",
   });
})();
</script>


<!-- EmailJS External Script + Safe Init -->
<script>
   (function(){
   const script = document.createElement('script');
   script.src = "assets/js/4_dist_email.js?v=2.0.1"; // فایل MailJS محلی شما
   script.async = true; // دانلود غیرمسدودکننده
   script.onload = () => {
   // مطمئن می‌شویم DOM آماده است قبل از init
